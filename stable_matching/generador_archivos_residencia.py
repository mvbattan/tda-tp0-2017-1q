...
file_name = sys.argv[0]   #input("Ingrese el nombre del archivo de salida: ")
N = sys.argv[1] #input("Ingrese la cantidad de estudiantes: ")
M = sys.argv[2] #input("Ingrese la cantidad de hospitales: ")
int(N)
int(M)
